...
const char* mqttTopic = "sensor/value";
const char* mqtt_topic = "sensors/temp";
...
//     if (client.connect("mqttClientId", "mqtt", "admin1234")) {
//       Serial.println("connected");
//       client.subscribe("Control/FaceRecognition");
//     } else {
...
void SensorDetect() {
  ...
  if (currentStatus && !objectDetected) {
    ...
    client.publish(mqttTopic, "1");  // Object no longer detected, send value "0"
  }
  if (objectDetected) {
    client.publish(mqttTopic, "0");  // Object detected, send value "1"
  }
  delay(100);
}
