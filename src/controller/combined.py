...
def sort_faces():
    selected_face = select_best_face('../../static/crop_picture/')
    if selected_face is not None:
        if not os.path.exists('../../static/crop_picture/temp_picture'):
            os.makedirs('../../static/crop_picture/temp_picture')
        cv2.imwrite('../../static/crop_picture/temp_picture/selected_face.jpg', selected_face)
